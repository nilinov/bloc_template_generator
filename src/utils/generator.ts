...
function init() {
    ...
    const name = (document.querySelector('input#blocName') as any).value || ( localStorage.name ?? 'Coupon');
    const itemType = (document.querySelector('input#blocItemType') as any).value || ( localStorage.itemType ?? 'Coupon');

    (document.querySelector('input#blocName') as any).value = name;
    (document.querySelector('input#blocItemType') as any).value = itemType;
...
function updateAll() {
    ...
    const name = (document.querySelector('input#blocName') as any).value;
    const itemType = (document.querySelector('input#blocItemType') as any).value;
